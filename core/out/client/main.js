import makeWASocket, { delay, DisconnectReason, jidNormalizedUser, makeCacheableSignalKeyStore, } from "baileys";
import pino from "pino";
import NodeCache from "@cacheable/node-cache";
import { createClient } from "redis";
import { loadPlugins } from "../plugins/index.js";
import serialize from "./seralize.js";
import { logForGo, getMessage, saveMessage, handleEvent, handleCommand, syncGroupMetadata, useHybridAuthState, cacheGroupMetadata, cachedGroupMetadata, syncGroupParticipantsToContactList, } from "../util/index.js";
const logger = pino({
    level: "trace",
    transport: {
        target: "pino/file",
